...
/**
 * Clase para generar imagen con filtro azul
 *
 * @author Kevin Pozuelos
 */
public class JPEGImageHandlerColors3 extends ImageHandler {
    ...
    /**
     * Constructor de la clase JPEGImageHandlerColors3
     *
     * @param filename
     */
    public JPEGImageHandlerColors3(String filename) {
        super(filename);
    }
    ...
    /**
     * Metodo para generar la imagen con el filtro de color azul.
     *
     * @throws Exception
     */
    @Override
    public void generateFiles() throws Exception {
        ...
        for (int a = 0; a < px.length; a++) {
            for (int b = 0; b < px[0].length; b++) {
                Color MC = px[a][b];
                int Rojo1 = MC.getBlue();
                Color Rojo2 = new Color(0, 0, Rojo1, 0);
                Rojo.setRGB(a, b, Rojo2.getRGB());
            }

        }

        File FinalR = new File("Resultados/" + "Blue-" + nombreF + ".jpg");
